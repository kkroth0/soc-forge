            ...
            while True:
                try:
                    ...
                    if choice == "0":
                        ...
                        # Check Threat Feeds Status
                        self.interface.display_threat_feeds_status()
                        self._continue_prompt()

                    elif choice == "5":
                        # Check DNS Blacklists (DNSBL)
                        self.interface.check_dnsbl()

                    elif choice == "6":
                        # List Available DNSBL Servers
                        self.interface.display_dnsbl_list()
